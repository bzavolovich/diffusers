...
try:
    ...
    _import_structure["pipeline_qwenimage_edit_controlnet_inpaint"] = ["QwenImageEditControlNetInpaintPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_qwenimage_edit_controlnet_inpaint import QwenImageEditControlNetInpaintPipeline
